    ...
    <UI.Navbar expand="sm">
        ...
        >
          ...
          {status === UserCurrentStatus.LoggedIn ? (
            <>
              ...
              <UI.NavLink href={`/auth/logout?r=${window.location.pathname}`}>Logout</UI.NavLink>
            </>
          ) : (
            <UI.NavLink href={`/auth/login?r=${window.location.pathname}`}>Login / Signup</UI.NavLink>
          )}
        </span>
      ...
      >
        {status === UserCurrentStatus.LoggedIn ? (
          ...
          <UI.NavbarLoginLink href={`/auth/login?r=${window.location.pathname}`}>Login / Signup</UI.NavbarLoginLink>
        )}
      </UI.NavbarSpan>
    </UI.Navbar>
  );
